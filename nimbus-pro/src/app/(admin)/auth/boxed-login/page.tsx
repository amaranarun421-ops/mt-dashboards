      ...
      <div className="relative w-full max-w-[400px]">
        ...
        <div className="animate-slide-up rounded-2xl border border-white/20 bg-white/95 p-6 shadow-theme-2xl backdrop-blur-xl dark:bg-gray-950/90 sm:p-7">
          ...
          <form onSubmit={onSubmit} className="space-y-3.5">
            <div>
              <Label htmlFor="boxed-login-email" required>Email</Label>
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <Label htmlFor="boxed-login-password" className="mb-0" required>Password</Label>
                <Link
        ...
        <p className="mt-5 text-center text-sm text-white/90 drop-shadow">
          ...
          <Link href="/auth/boxed-register" className="font-semibold text-white underline-offset-2 hover:underline">
            Sign up
          </Link>
        </p>
      </div>
