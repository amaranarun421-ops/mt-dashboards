  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:cursor-pointer',
  {
    variants: {
      variant: {
        ...
        outlinesuccess:
          'border border-success bg-background hover:bg-success text-success hover:text-white',
        outlinewarning:
          'border border-warning bg-background hover:bg-warning text-warning hover:text-white',
        outlineinfo:
          'border border-info bg-background hover:bg-info text-info hover:text-white',
        outlineerror:
          'border border-error bg-background hover:bg-error text-error hover:text-white',
